...
podTemplate(
    ...
    node('poc-microservices-users') {
        def REPOSITORY
        def GIR_URL_REPOSITORY = 'git@github.com:lhenriquegomescamilo/poc-microservices-users.git'
        def DOCKER_IMAGE = "gateway_users"
        def DOCKER_IMAGE_VERSION = ""
        def MICROSERVICE_NAME = "users"
